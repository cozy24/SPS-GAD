...
def train(model, graph, args, device, quantile):
    ...
    for epoch in range(args.epoch):
        ...
        output, edge_pred, reconstruction_loss = model(graph, features)
        total_loss = 0
    ...
    return final_trec, final_tpre, final_tmf1, final_tauc, final_gmean, train_times, inference_times, train_memories, inference_memories
...
if __name__ == '__main__':
    ...
    for tt in range(args.run):
        ...
        rec, pre, mf1, auc, gmean, train_times, inference_times, train_memories, inference_memories = train(model, graph, args, device, edge_weight)
